...
**_Purpose_**: this website provides an overview of which chassis suspension features are most important in relation to their influence on boom height stability of self-propelled sprayers.
...
**_Goal_**: this project intends to analyze the interactions of the chassis on overall boom height stability.  By classifying the most important chassis performance features with how they relate to boom motion, the highest ranked parameters can be prioritized for future product development work.  
